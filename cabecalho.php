<header id="header">
				<div class="container">
					<div class="logo">
						<a href="index.php">
							<img alt="Porto" width="302" height="56" data-sticky-width="151" data-sticky-height="28" src="img/logo.png">
						</a>
					</div>
					<div class="search">
					...
					<nav>
						<ul class="nav nav-pills nav-top">
							<li>
								<a href="index.php?page=sobrenos"><i class="fa fa-angle-right"></i>Sobre nós</a>
							</li>
							<li>
								<a href="index.php?page=contato"><i class="fa fa-angle-right"></i>Nosso Contato</a>
							</li>
							<li class="phone">
								<span><i class="fa fa-phone"></i>+55 (21) 9 9110-5857</span>
							</li>
						</ul>
					</nav>
