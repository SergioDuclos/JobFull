					...
					<div class="slider" id="revolutionSlider" data-plugin-revolution-slider data-plugin-options='{"startheight": 490}'>
						<ul>
							<li data-slotamount="7" data-masterspeed="1000" data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7">
								<img src="img/banner_full.jpg" alt="light" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
								...
								<!--<div class="tp-caption tp-fade fadeout fullscreenvideo"
									...
									<video preload="none" width="100%" height="100%" poster="img/banner_full.jpg"> 
						...
						<div class="row center">
							...
							<div class="col-md-2 col-md-offset-1">
								<div class="process-image" data-appear-animation="bounceIn">
									<img src="img/banner_estrategia.png" alt="" />
									<strong>Estrategia</strong>
								</div>
							</div>
							<div class="col-md-2">
								<div class="process-image" data-appear-animation="bounceIn" data-appear-animation-delay="200">
									<img src="img/banner_planejamento.png" alt="" />
							...
							<div class="col-md-4 col-md-offset-1">
								<div class="project-image">
									<div id="fcSlideshow" class="fc-slideshow">
										<ul class="fc-slides">
											<li><a href="portfolio-single-project.html"><img class="img-responsive" src="img/project-home-1.jpg" /></a></li>
											<li><a href="portfolio-single-project.html"><img class="img-responsive" src="img/project-home-2.jpg" /></a></li>

<!--
											<li><a href="portfolio-single-project.html"><img class="img-responsive" src="img/project-home-3.jpg" /></a></li>
-->
										</ul>
									</div>
									<strong class="our-work">Nosso Trabalho!</strong>
								</div>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-8">
							<h2>Nossos <strong>Recursos</strong></h2>
							<div class="row">
								<div class="col-sm-6">
									<div class="feature-box">
										...
										<div class="feature-box-info">
											<h4 class="shorter">Suporte ao Cliente</h4>
											<p class="tall">Suporte em até 24h.</p>
										</div>
									</div>
									<div class="feature-box">
										<div class="feature-box-icon">
								...
								<div class="col-sm-6">
									...
									<div class="feature-box">
										...
										<div class="feature-box-info">
											<h4 class="shorter">Botões Especiais</h4>
											<p class="tall">Botões fáceis de selecionar e intuitivos.</p>
										</div>
									</div>
									<div class="feature-box">
										<div class="feature-box-icon">
